...
euro2016App.config(function($routeProvider) {
    ...
    $routeProvider
		...
		.when('/rank_of_comnunity/:com_id', { templateUrl:'communities/static/rank_in_community.html', controller:'CommunitiesCtrl' })
		.when('/bets_of_comnunity/:com_id', { templateUrl:'communities/static/bets_in_community.html', controller:'CommunitiesCtrl' })
